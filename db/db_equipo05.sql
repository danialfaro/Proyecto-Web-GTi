...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2021 a las 18:30:41
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('admin','tecnico','user','gerente') DEFAULT NULL,
...
INSERT INTO `usuarios` (`id`, `nombre`, `apellidos`, `contrasenya`, `id_cliente`, `rol`, `bloqueado`) VALUES
(1, 'admin', NULL, '1234', 0, 'admin', 0),
(2, 'user', NULL, '1234', 0, 'user', 0),
(7, 'dani', NULL, '1234', 0, 'user', 0);
